...
if (true){ //$_SESSION['login']==1
	...
	if ($_GET['del']!=""){
	  $id=$_GET['del'];
	  mysqli_query($GLOBALS["___mysqli_ston"], "delete from soci where id='$id'");
	  mysqli_query($GLOBALS["___mysqli_ston"], "delete from interessi_soci where id_socio='$id'");
	  echo '<script type="text/javascript">
		...
		$result=mysqli_query($GLOBALS["___mysqli_ston"], "select id,nome,mail from soci order by mail");
