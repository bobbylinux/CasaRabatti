...
<html>
    ...
    \* ---------------------------------------------------------------------- */
        ...
        function insertPdf() {
            var pdf = document.getElementById('linkType').value + document.getElementById('url').value;
            window.opener.document.getElementById('wysiwyg' + qsParm['wysiwyg']).contentWindow.document.execCommand("CreateLink", false, pdf);
            window.close();
        }
    ...
    <body bgcolor="#EEEEEE" marginwidth="0" marginheight="0" topmargin="0" leftmargin="0" onLoad="retrieveWYSIWYG();">
        ...
        if (isset($_POST['uploadfile'])) {
            ...
            //$dir = 'benci/sendletter/wysiwyg/tmpdoc';
            ...
            $content = ((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="padding: 10px;"><tr><td>
                        ...
                        <span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Insert Pdf:</span>
                        ...
                        <div align="right" style="padding-top: 5px;"><input type="submit" value="  Inserisci  " onClick="insertPdf();" style="font-size: 12px;" >&nbsp;<input type="submit" value="  Cancel  " onClick="window.close();" style="font-size: 12px;" ></div>

                </tr></td></table>
    <?php } else { ?> 
        <form name="submit" action="insert_pdf.php?wysiwyg=7" method="POST" enctype="multipart/form-data">
            <table border="0" cellpadding="0" cellspacing="0" style="padding: 10px;"><tr><td>
