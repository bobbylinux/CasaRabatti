...
// Images Directory
imagesDir = "http://casarabatti.dev/wp-content/themes/casarabatti/sendletter/wysiwyg/icon/";

// CSS Directory
cssDir = "http://casarabatti.dev/wp-content/themes/casarabatti/sendletter/wysiwyg/styles/";

// Popups Directory
popupsDir = "http://casarabatti.dev/wp-content/themes/casarabatti/sendletter/wysiwyg/popups/";
...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  ...
  "underline":      ['Underline',            'Underline',          imagesDir + 'underline.gif',          imagesDir + 'underline_on.gif'],
	...
	"createlink":     ['CreateLink',           'CreateLink',         imagesDir + 'insert_hyperlink.gif',   imagesDir + 'insert_hyperlink_on.gif'],
        "insertpdf":      ['InsertPdf',            'InsertPdf',          imagesDir + 'insert_pdf.gif',         imagesDir + 'insert_pdf_on.gif'],
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	var formatIDs = new Array("FontSize","FontName","Bold","Italic","Underline","Subscript","Superscript","Strikethrough","Justifyleft","Justifyright","Justifycenter","InsertUnorderedList","InsertOrderedList","Indent","Outdent","ForeColor","BackColor","InsertImage","InsertTable","CreateLink","InsertPdf");
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.php?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=250');
	  }
	    ...
	    window.open(popupsDir + 'insert_hyperlink.html?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=300,height=110');
                ...
                //InsertPdf
          else if (id == "InsertPdf") {
            window.open(popupsDir + 'insert_pdf.php?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=300,height=150');
          }
...
function outputFontSizes(n) {
  ...
  FontSizesDropDown[n] += '<span id="Sizes' + n + '" class="dropdown" style="width: 170px;">';
	...
	for (var i = 0; i <= FontSizes.length;) {
	  if (FontSizes[i]) {
      FontSizesDropDown[n] += '<button type="button" onClick="formatText(\'FontSize\',\'' + n + '\',\'' + FontSizes[i] + '\')\;hideFontSizes(\'' + n + '\');" onMouseOver="this.className=\'mouseOver\'" onMouseOut="this.className=\'mouseOut\'" class="mouseOut" style="width: 145px;"><table cellpadding="0" cellspacing="0" border="0"><tr><td align="left" style="font-family: arial, verdana, helvetica;"><font size="' + FontSizes[i] + '">Dimensione ' + FontSizes[i] + '</font></td></tr></table></button><br>';	
    }	  
	  i++;
  }
